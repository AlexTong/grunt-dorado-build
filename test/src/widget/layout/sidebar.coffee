class dorado.Sidebar extends dorado.AbstractContainer
...
class dorado.Drawer extends dorado.AbstractContainer
	...
	_hideSidebar: ()->
		...
		while child
			if child.nodeType == 1
				...
				if widget and widget instanceof dorado.Sidebar and widget.isVisible()
					widget.hide()
