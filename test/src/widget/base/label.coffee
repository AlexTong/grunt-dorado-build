class dorado.Label extends dorado.Widget
	@SEMANTIC_CLASS: [
...
class dorado.ImageLabel extends dorado.Label
...
class dorado.PointingLabel extends dorado.Label
...
class dorado.Tag extends dorado.Label
	@CLASS_NAME: "tag label"


class dorado.Corner extends dorado.Label
...
class dorado.Ribbon extends dorado.Label
		...
		position:
			...
			setter: (value)->
				...
				if oldValue is "right" and @_dom
					dorado.util.removeClass(@_dom, "right ribbon", true)
